...
const InteriorPaint = () => {
  ...
  return (
    <div className="interior-paint">
      <div className="container">
        <div className="title-section text-center">
          <h2 className="flat-title color-one">
            {t('titleSection.interiorPaint')}
          </h2>
          <p>Description</p>
        </div>

        <div className="row interior-paint__columns four-columns">
          {loading ? (
            <p>Loading...</p>
          ) : error ? (
            <p>{error.message}</p>
      ...
      <div className="image-position">
        <img src="../assets/images/section/03.png" alt="images" />
      </div>
    </div>
  );
};
